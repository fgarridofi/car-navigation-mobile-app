...
import com.example.formapp.databinding.ActivityMain2Binding
...
// and later when a route is set also receiving route progress updates
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val direccionSeleccionada = intent.getStringExtra("direccion_seleccionada")
        ...
        Log.e("aaaaa",destinationPoint.toString())
...
// initialize location puck
    ...
    private fun findRoute() {
        ...
        if (originLocation != null) {
            ...
            // Rest of the findRoute implementation
        } else {
            // Retry after 1 second
            Handler(Looper.getMainLooper()).postDelayed({ findRoute() }, 600)
        }
        ...
        Log.e("eeeee",originPoint.toString())
