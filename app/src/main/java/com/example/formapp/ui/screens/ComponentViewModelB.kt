...
@HiltViewModel
class ComponentViewModelB @Inject constructor (private val componentRepository: ComponentRepositoryB) : ViewModel() {
            ...
            if (result is Result.Success) {
                ...
                if (components != null) {
                    components.forEach { component ->
                        if (component.id == id) {
                            val updatedComponent = component.copy(kilometers = component.kilometers + newKilometers)
